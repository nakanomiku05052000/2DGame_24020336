...
void BossObject::OnMap(Map& g_map)
{
...
void BossObject::CheckMap(Map& g_map)
{
	...
	if(x1 >= 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 < MAX_MAP_Y)
	{
		if(x_val_ > 0)
		{
			if((g_map.tile[y1][x2] != 0) || (g_map.tile[y2][x2] != 0))
			{
				x_pos_ = x2 * TILE_SIZE;
		...
		{
			if((g_map.tile[y1][x1] != 0) || (g_map.tile[y2][x1] != 0))
			{
	...
	if(x1 > 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 < MAX_MAP_Y)
	{
		if(y_val_ > 0)
		{
			if((g_map.tile[y2][x1] != 0) || (g_map.tile[y2][x2] != 0))
			{
				y_pos_ = y2 * TILE_SIZE;
		...
		{
			if((g_map.tile[y1][x1] != 0) || (g_map.tile[y1][x2] != 0))
			{
